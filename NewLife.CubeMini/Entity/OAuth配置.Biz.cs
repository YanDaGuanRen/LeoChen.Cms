...
public partial class OAuthConfig : Entity<OAuthConfig>
{
    ...
    protected override void InitData()
    {
        ...
        //Add("NewLife", "新生命用户中心", "/CubeContent/images/logo/NewLife.png");
        var entity = new OAuthConfig
        {
            Name = "NewLife",
            NickName = "新生命用户中心",
            Logo = "/CubeContent/images/logo/NewLife.png",
        ...
        Add("QQ", "QQ", "/CubeContent/images/logo/QQ.png");
        Add("Github", "Github", "/CubeContent/images/logo/Github.png");
        Add("Baidu", "百度", "/CubeContent/images/logo/Baidu.png");
        Add("Ding", "钉钉", "/CubeContent/images/logo/Ding.png", "snsapi_qrlogin扫码登录，snsapi_auth钉钉内免登，snsapi_login密码登录");
        Add("QyWeiXin", "企业微信", "/CubeContent/images/logo/QyWeiXin.png");
        //Add("Weixin", "微信公众号", "/CubeContent/images/logo/Weixin.png", "snsapi_base静默登录，snsapi_userinfo需要用户关注后授权");
        var cfg = new OAuthConfig
        {
            Name = "Weixin",
            NickName = "微信公众号",
            Logo = "/CubeContent/images/logo/Weixin.png",
