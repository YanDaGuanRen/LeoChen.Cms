...
public partial class CmsFormField : Entity<CmsFormField>
{
    #region 对象操作
    static CmsFormField()
    {
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("开始初始化CmsFormField[自定义表单字段]数据……");

    //    var entity = new CmsFormField();
    //    entity.FormID = 0;
    //    entity.Name = "abc";
    //    entity.FieldType = 0;
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("完成初始化CmsFormField[自定义表单字段]数据！");
    //}
    ...
    #region 业务操作
    public ICmsFormField ToModel()
    {
        var model = new CmsFormField();
        model.Copy(this);
