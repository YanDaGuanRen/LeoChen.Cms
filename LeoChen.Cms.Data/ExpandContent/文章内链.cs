...
[DataObject]
[Description("文章内链")]
[BindIndex("IX_CmsTags_AreaID", false, "AreaID")]
[BindIndex("IU_CmsTags_Name", true, "Name")]
[BindTable("CmsTags", Description = "文章内链", ConnName = "Membership", DbType = DatabaseType.None)]
public partial class CmsTags : ICmsTags, IEntity<ICmsTags>
{
    #region 属性
    private Int32 _ID;
    ...
    public static CmsTags FindByID(Int32 id)
    {
        if (id < 0) return null;
    ...
    /// <returns>实体对象</returns>
    public static CmsTags FindByName(String name)
    {
        ...
        // 单对象缓存
        return Meta.SingleCache.GetItemWithSlaveKey(name) as CmsTags;
    ...
    /// <returns>实体列表</returns>
    public static IList<CmsTags> Search(Int32 areaId, DateTime start, DateTime end, String key, PageParameter page)
    {
    ...
    #region 字段名
    /// <summary>取得文章内链字段信息的快捷方式</summary>
    ...
    /// <summary>取得文章内链字段名称的快捷方式</summary>
