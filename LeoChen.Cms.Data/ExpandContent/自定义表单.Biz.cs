...
public partial class CmsForm : Entity<CmsForm>
{
    #region 对象操作
    static CmsForm()
    {
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("开始初始化CmsForm[自定义表单]数据……");

    //    var entity = new CmsForm();
    //    entity.Name = "abc";
    //    entity.Description = "abc";
    //    entity.Enable = true;
    //    entity.Insert();

    //    if (XTrace.Debug) XTrace.WriteLine("完成初始化CmsForm[自定义表单]数据！");
    //}
    ...
    #region 业务操作
    public ICmsForm ToModel()
    {
        var model = new CmsForm();
        model.Copy(this);
