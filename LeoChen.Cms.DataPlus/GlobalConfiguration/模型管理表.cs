...
[DataObject]
[Description("模型管理表")]
[BindIndex("IU_CmsModel_TenantId_Name", true, "TenantId,Name")]
[BindIndex("IX_CmsModel_TenantId", false, "TenantId")]
...
public partial class CmsModel : ICmsModel, IEntity<ICmsModel>
{
    ...
    /// <returns>实体对象</returns>
    public static CmsModel FindByTenantIdAndName(Int32 tenantId, String name)
    {
    ...
    public static IList<CmsModel> FindAllByTenantId(Int32 tenantId)
    {
    ...
    /// <returns>实体列表</returns>
    public static IList<CmsModel> Search(Int32 tenantId, Boolean? modelType, Boolean? status, Boolean? isSystem, DateTime start, DateTime end, String key, PageParameter page)
    {
