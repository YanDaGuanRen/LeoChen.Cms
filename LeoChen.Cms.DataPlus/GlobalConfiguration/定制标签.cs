...
[DataObject]
[Description("定制标签")]
[BindIndex("IU_CmsLabel_TenantId_Name", true, "TenantId,Name")]
[BindIndex("IX_CmsLabel_TenantId", false, "TenantId")]
...
public partial class CmsLabel : ICmsLabel, IEntity<ICmsLabel>
{
    ...
    public static CmsLabel FindByID(Int32 id)
    {
        if (id < 0) return null;
    ...
    /// <returns>实体对象</returns>
    public static CmsLabel FindByTenantIdAndName(Int32 tenantId, String name)
    {
    ...
    public static IList<CmsLabel> FindAllByTenantId(Int32 tenantId)
    {
    ...
    /// <param name="tenantId">租户</param>
    /// <param name="labelType">类型</param>
    /// <param name="start">更新时间开始</param>
    /// <param name="end">更新时间结束</param>
    /// <param name="key">关键字</param>
    /// <param name="page">分页参数信息。可携带统计和数据权限扩展查询等信息</param>
    /// <returns>实体列表</returns>
    public static IList<CmsLabel> Search(Int32 tenantId, LeoChen.Cms.Data.CmsItemType labelType, DateTime start, DateTime end, String key, PageParameter page)
    {
        var exp = new WhereExpression();

        if (tenantId >= 0) exp &= _.TenantId == tenantId;
        if (labelType >= 0) exp &= _.LabelType == labelType;
    ...
    #region 字段名
    /// <summary>取得定制标签字段信息的快捷方式</summary>
    ...
    /// <summary>取得定制标签字段名称的快捷方式</summary>
