...
[DataObject]
[Description("扩展字段表")]
[BindIndex("IU_CmsExtfield_TenantId_Name", true, "TenantId,Name")]
[BindIndex("IX_CmsExtfield_ContentSortID", false, "ContentSortID")]
[BindIndex("IX_CmsExtfield_TenantId", false, "TenantId")]
...
public partial class CmsExtfield : ICmsExtfield, IEntity<ICmsExtfield>
{
    ...
    /// <returns>实体对象</returns>
    public static CmsExtfield FindByTenantIdAndName(Int32 tenantId, String name)
    {
    ...
    public static IList<CmsExtfield> FindAllByTenantId(Int32 tenantId)
    {
    ...
    /// <returns>实体列表</returns>
    public static IList<CmsExtfield> Search(Int32 tenantId, Int32 contentSortId, DateTime start, DateTime end, String key, PageParameter page)
    {
