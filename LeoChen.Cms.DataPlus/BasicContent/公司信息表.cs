...
[BindIndex("IX_CmsCompany_TenantId", false, "TenantId")]
...
public partial class CmsCompany : ICmsCompany, IEntity<ICmsCompany>
{
    ...
    public static IList<CmsCompany> FindAllByTenantId(Int32 tenantId)
    {
    ...
    /// <returns>实体列表</returns>
    public static IList<CmsCompany> Search(Int32 tenantId, Int32 areaId, DateTime start, DateTime end, String key, PageParameter page)
    {
