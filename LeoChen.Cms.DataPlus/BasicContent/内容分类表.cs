...
[BindIndex("IU_CmsContent_Sort_TenantId_Name", true, "TenantId,Name")]
[BindIndex("IX_CmsContent_Sort_TenantId", false, "TenantId")]
...
public partial class CmsContent_Sort : ICmsContent_Sort, IEntity<ICmsContent_Sort>
{
    ...
    /// <returns>实体对象</returns>
    public static CmsContent_Sort FindByTenantIdAndName(Int32 tenantId, String name)
    {
    ...
    /// <param name="tenantId">租户</param>
    /// <returns>实体列表</returns>
    public static IList<CmsContent_Sort> FindAllByTenantId(Int32 tenantId)
    {
    ...
    /// <returns>实体列表</returns>
    public static IList<CmsContent_Sort> Search(Int32 tenantId, Int32 areaId, Int32 pid, Int32 modelId, Int32 sorting, Boolean? status, DateTime start, DateTime end, String key, PageParameter page)
    {
